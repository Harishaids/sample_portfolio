        ...
        <div className='container mx-auto px-8 md:px-16 lg:px-24'>
            ...
            <div className='flex flex-col md:flex-row items-center md:space-x-12'>
                ...
                <div className='flex-1'>
                    <p className='text-lg mb-8'>I am a passionate fullstack developer with focus on build modern and responsible web applications.With a strong foundation in both frontend and backend technologies , I strive to create seamless efficient user experiences.</p>
